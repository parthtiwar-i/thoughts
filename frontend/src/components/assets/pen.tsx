export const Pen = () => {
  return (
    ...
    >
      <g id="Object">
        <g  transform="rotate(-20 250 0)">

          <path
            fill="#616E7D"
            d="M330.043,796.912l-2.257,0.194l-84.941,84.931l-0.206,2.237l2.157,0.626l160.864-70.261
          ...
          <path
            fill="#82BFAB"
            d="M509.115,502.751L619.26,612.884c134.148-138.263,291.273-343.103,262.108-372.255
            C852.228,211.481,647.385,368.599,509.115,502.751z"
          />
          <path
            fill="#82BFAB"
            d="M417.156,704.843c25.179,25.187,40.164,52.677,122.089-15.962L433.131,582.757
            C364.487,664.685,391.978,679.661,417.156,704.843z"
          />
          <path
            fill="#AAD4C8"
            d="M539.245,688.88c9.229-7.731,19.312-16.688,30.341-26.998L460.13,552.41
            c-10.315,11.039-19.283,21.127-26.999,30.347L539.245,688.88z"
          />
          <path
            fill="#616E7D"
            d="M460.13,552.41l109.456,109.472c9.651-9.018,19.961-18.971,31.171-30.18
